...
function BlogPostPageContent({ sidebar, children, }) {
    ...
    return (<BlogLayout sidebar={sidebar} toc={!hideTableOfContents && toc.length > 0 ? (<TOC toc={toc} minHeadingLevel={tocMinHeadingLevel} maxHeadingLevel={tocMaxHeadingLevel}/>) : undefined}>
      {unlisted && <Unlisted />}
...
export default function BlogPostPage(props) {
    ...
    return (<BlogPostProvider content={props.content} isBlogPostPage>
